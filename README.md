...
coffeeflow/ 
ÃÄÄ manage.py 
ÃÄÄ coffeeflow/          # Project settings 
ÃÄÄ apps/ 
³   ÃÄÄ accounts/        # User authentication 
³   ÃÄÄ farmers/         # Farmer profiles 
³   ÃÄÄ deliveries/      # Coffee batch tracking 
³   ÃÄÄ payments/        # Payment processing 
³   ÀÄÄ mobile_api/      # REST API endpoints 
ÃÄÄ templates/           # HTML templates 
ÃÄÄ static/              # CSS, JS, images 
ÀÄÄ media/               # Uploaded files 
\`\`\` 
